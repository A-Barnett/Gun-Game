...
public class M1911Controller : MonoBehaviour
{
    [SerializeField]private float adsTime,adsTimeReturn,aimYRotate,fireRate,shotForce,bulletSpread,aimSpreadReduction;
    ...
    [SerializeField]private Animator M1911Animation;
    ...
    private  Quaternion targetRotation = Quaternion.Euler(new Vector3(310f, 180, 0));
    ...
    private void HandleAiming()
    {
        if (Input.GetMouseButton(1))
        {
            ...
            transform.localPosition = Vector3.Lerp(transform.localPosition, origWeaponPos + new Vector3(-0.1520973f, aimYRotate, -0.235f), Time.deltaTime * adsTime);
            transform.localRotation = Quaternion.Euler(new Vector3(270, 180, 0));
        }
        else
        {
    ...
    private void Fire()
    {
        M1911Animation.Play("M1911Fire",0,0f);
